...
public class GraphUtil {
    public static void addRandomEdges(SinglyLinkedListGraph graph, int maxEdges) throws ListException, GraphException {
    ...
    public static boolean isReachable(SinglyLinkedListGraph graph, Object start, Object target) throws ListException {
        boolean[] visited = new boolean[graph.vertexList.size() + 1];
        return dfs(graph, graph.indexOf(start), graph.indexOf(target), visited);
    }

    public static boolean dfs(SinglyLinkedListGraph graph, int current, int target, boolean[] visited) throws ListException {
    ...
    private static SinglyLinkedList reconstructPath(int[] anterior, int destino, SinglyLinkedListGraph graph, double distanciaFinal) throws ListException {
    ...
    public static SinglyLinkedList dijkstra(Object origen, Object destino, SinglyLinkedListGraph graph) throws Exception {
