...
//            if (isEmpty())
//                throw new ListException("Singly Linked List is empty");
//            if (Utility.instanceOf(first, first).equals("Student"))
//                throw new ListException("Singly Linked List is not a Student List");
//            boolean swapped;
//            do {
//                Node current = first;
//                swapped = false;
//                while (current.next != null) {
//                    // Compara solo los nombres de los estudiantes
//                    Student currentStudent = (Student) current.data;
//                    Student nextStudent = (Student) current.next.data;
//                    if (currentStudent.getName().compareToIgnoreCase(nextStudent.getName()) > 0) {
